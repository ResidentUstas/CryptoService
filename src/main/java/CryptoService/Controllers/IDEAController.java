    ...
    public String Encrypt(Model model, @ModelAttribute("cipher") CipherModel cipherText) throws DecoderException, IOException {
        ...
        switch (cipherText.getMode()){
            case 1:
                ...
                model.addAttribute("path", "D:\\Block_Algorithms\\Block_Ciphers\\Hemming\\IDEA\\idea_cipher_result.txt");
                break;
            case 2:
            ...
            case 3:
                ...
                model.addAttribute("path", "D:\\Block_Algorithms\\Block_Ciphers\\decipher\\IDEA\\idea_hemming_result.txt");
                break;
        }
